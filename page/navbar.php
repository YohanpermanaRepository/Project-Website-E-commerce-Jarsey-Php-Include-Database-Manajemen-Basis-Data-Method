...
if (isset ($_SESSION['username'])){
  if ($_SESSION['status'] == 'user'){
    ...
    echo "<li><a href='?page=evaluasi'>Evaluasi</a></li>";
  ...
  echo "<li><a href='?page=beranda'>Home</a></li>";
  echo "<li><a href='?page=tentang'>Developer</a></li>";
  echo "<li class='login'><a href='page/login.php'>Login</a></li>";
}
 ?>

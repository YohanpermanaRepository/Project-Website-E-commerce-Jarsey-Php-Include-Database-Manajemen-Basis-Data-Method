...
if (isset($_SESSION['username'])) {
    ...
    $query = $conn->prepare("SELECT id,deskripsi,harga,ukuran,qty,kurir,total,date_in
                            FROM tbl_keranjang
    ...
    $count = 0; // Mengatur $count menjadi 0 jika tidak ada sesi username
}
?>
...
<div id="keranjang">
    <table class="news">
        ...
        if ($count > 0) {
            ...
            echo '<tr><td colspan="10">Keranjang belanja kosong.</td></tr>';
        }
        ?>
        <?php if ($count > 0) { ?>
            <tr>
